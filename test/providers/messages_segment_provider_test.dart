...
void main() {
  test('messagesBrowserUrl returns notice page for segment 0', () {
  ...
  test('messagesBrowserUrl returns pm page for segment 1', () {
  ...
  test('messagesBrowserUrl follows selected system notice feed', () {
    final url = messagesBrowserUrl(0, noticeFeed: NoticeFeed.system);
    expect(url, contains('view=system'));
  });

  test('messagesBrowserUrl retains the current page', () {
    expect(messagesBrowserUrl(1, page: 3), contains('page=3'));
    expect(
      messagesBrowserUrl(0, noticeFeed: NoticeFeed.system, page: 4),
      contains('page=4'),
    );
  });
}
