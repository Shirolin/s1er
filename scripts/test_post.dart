...
void main() async {
  ...
  final body = 'formhash=test&fastloginfield=username&username=test&password=test&questionid=0&answer=&cookietime=2592000';
  
  final req = await client.postUrl(Uri.parse('https://stage1st.com/2b/member.php?mod=logging&action=login&loginsubmit=yes&mobile=2'));
